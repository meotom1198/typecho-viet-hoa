                    ...
                    <form method="post" name="theme" id="theme"
                        ...
                        <p class="typecho-option typecho-option-submit">
                            <?php if ($files->currentIsWriteable()): ?>
                                ...
                                <button type="submit" class="btn primary"><?php _e('Lưu tập tin'); ?></button>
                            <?php else: ?>
                                <em><?php _e('Tập tin này không thể được sửa!'); ?></em>
                            <?php endif; ?>
                        </p>
                    </form>
                </div>
                <ul class="col-mb-12 col-tb-4 col-3">
                    <li><strong>Tập tin mẫu</strong></li>
