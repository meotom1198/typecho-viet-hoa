                    ...
                    <table class="typecho-list-table">
                        ...
                        ?>">
                            ...
                            <td valign="top" class="comment-body">
                                <div class="comment-date"><i class="fa-regular fa-clock"></i> <?php $comments->dateWord(); ?> | Tại bài viết: <a href="<?php $comments->permalink(); ?>"><?php $comments->title(); ?></a></div>
                                ...
                                <div class="comment-action hidden-by-mouse">
                                    ...
                                    <i class="fa-solid fa-x"></i> <a lang="<?php _e('Bạn có chắc chắn muốn xóa bình luận của %s không?', htmlspecialchars($comments->author)); ?>" href="<?php $security->index('/action/comments-edit?do=delete&coid=' . $comments->coid); ?>" class="operate-delete"><?php _e('Xóa bỏ'); ?></a>
                                </div>
                            </td>
                        </tr>
                        <?php endwhile; ?>
