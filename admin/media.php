            ...
            <div class="col-mb-12 col-tb-8" role="main">
                ...
                <div id="upload-panel" class="p">
                    <div class="upload-area"
                         draggable="true"><?php _e('Thả tệp vào đây <br>hoặc %schọn tệp tải lên%s', '<a href="###" class="upload-file">', '</a>'); ?></div>
                    <ul id="file-list"></ul>
                </div>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function fileUploadComplete(id, url, data) {
            ...
            $('#' + id).text('<?php _e('Tệp %s đã được thay thế'); ?>'.replace('%s', data.title))
